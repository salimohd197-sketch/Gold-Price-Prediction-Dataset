...
# Input fields matching the model's expected features: ['SPX', 'USO', 'SLV', 'EUR/USD']
...
# Load the model safely and Predict
if st.button("Predict Gold Price"):
    try:
        # Humne aapki file ka bilkul sahi naam 'gold_model.pkl' yahan set kar diya hai
        ...
        st.error("Error: 'gold_model.pkl' file nahi mili! Please check your repository.")
    except Exception as e:
        st.error(f"Prediction mein masla hua: {e}")
